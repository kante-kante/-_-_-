...
# row_range = ws[2:6] # 2번째 줄에서 6번째 줄까직 가지고 오기. 슬라이싱은 -1까지였지만 엑셀은 해당 숫자까지
...
#     for cell in rows:
#         # print(cell.value, end=" ")
#         # print(cell.coordinate, end=" ") # A/10, AZ/250 문자열과 숫자열을 끊어서 보여줌
...
#데이터를 한 줄씩: iter_rows, 데이터를 한 열씩: iter_cols
wb.save("sample.xlsx")